...
The Agent receives a reward of +1 for collecting yellow bananas and a -1 for a blue banana. The problem is considered solved when the Agent scores an average of +13 or more over 100 episodes. There is a "benchmark" solution showcased in the project instructions that solves the problem in 1700 episodes. It is expected that our solution will provide better performance.
